...
// }) => {
//   const [filter, setFilter] = useState<ActiveFilter>('active');
//   // Стек курсоров: [undefined] — первая страница, далее lastId предыдущих страниц
//   const [cursorStack, setCursorStack] = useState<(number | null | undefined)[]>(
//     [null]
//   );
//   const currentCursor = cursorStack[cursorStack.length - 1];

//   // Преобразуем фильтр в параметр onlyActive
//   const onlyActive: boolean | undefined =
//     filter === 'active' ? true : filter === 'hidden' ? false : undefined;

//   const { data, isLoading, error } = useSelections(
//     currentCursor ?? null,
//     LIMIT,
//     onlyActive
//   );

//   const handleFilterChange = (next: ActiveFilter) => {
//     setFilter(next);
//     setCursorStack([null]); // сбрасываем пагинацию при смене фильтра
//   };

//   const handleNextPage = () => {
//     if (data?.hasNext && data.lastId) {
